...
def liste(request):
	...
	return render(request, 'notification/liste.html', {'envois_non_lus': envois_non_lus, 'envois_lus': envois_lus})
...
def preferences(request):
	...
	return render(request, 'notification/preferences.html', {'associations':associations})