...
//	objDiv.scrollTop = objDiv.scrollHeight;
	...
	for(message in payload.messages) {
		...
		if (loadedOnce){
			...
			for (popineauWord in popineauWords){
				if (messageText.toLowerCase().search(popineauWords[popineauWord]) > -1){
					document.getElementById("popineauSoundPlayer").play();
				}
			}
