...
def trombi_assos(request):
    ...
    return render(request, 'trombiassos/trombi1.html', {'mineur_list': mineur_list,'assoces':assoces,'adhesions':adhesions})
	
@login_required
def trombi_assos1(request):
    """Le trombinoscope des élèves des Mines. N'affique que les 1A, 2A, 3A, et 4A"""    
    mineur_list = UserProfile.objects.promos_actuelles(1)
    adhesions = Adhesion.objects.all()
    assoces = Association.objects.all()
    ...
    for mineur in mineur_list :
        if i < 2 :
            ...
            a.append(mineur)
            mineur_list2.append(a)
            a=[]
            i=0
    return render(request, 'trombiassos/trombi1.html', {'mineur_list2': mineur_list2,'assoces':assoces,'adhesions':adhesions})
@login_required
def trombi_assos2(request):
    """Le trombinoscope des élèves des Mines. N'affique que les 1A, 2A, 3A, et 4A"""    
    mineur_list = UserProfile.objects.promos_actuelles(1)
    adhesions = Adhesion.objects.all()
    assoces = Association.objects.all()
...
def trombi_assos3(request):
    ...
    for mineur in mineur_list :
        if i < 4 :
            ...
            a=[]
            i=0
    return render(request, 'trombiassos/trombi3.html', {'mineur_list2': mineur_list2,'assoces':assoces,'adhesions':adhesions})
@login_required
def trombi_assos4(request):
    """Le trombinoscope des élèves des Mines. N'affique que les 1A, 2A, 3A, et 4A"""    
    mineur_list = UserProfile.objects.promos_actuelles(1)
    adhesions = Adhesion.objects.all()
    assoces = Association.objects.all()
    ...
    for mineur in mineur_list :
        if i < 5 :
            ...
            a=[]
            i=0
    return render(request, 'trombiassos/trombi4.html', {'mineur_list2': mineur_list2,'assoces':assoces,'adhesions':adhesions})
@login_required
def trombi_assos1fant(request):
    """Le trombinoscope des élèves des Mines. N'affique que les 1A, 2A, 3A, et 4A"""    
    mineur_list = UserProfile.objects.promos_actuelles(5)
    adhesions = Adhesion.objects.all()
    assoces = Association.objects.all()
    mineur_list2=[]
    a=[]
    ...
    for mineur in mineur_list :
        for ad in adhesions :
            if ad.association_id == 57 :
                if ad.eleve_id == mineur.id :
                    if i < 3 :
                        a.append(mineur)
                        i=i+1
                    else :
                        ...
                        a=[]
                        i=0
    return render(request, 'trombiassos/trombifant.html', {'mineur_list2': mineur_list2,'assoces':assoces,'adhesions':adhesions})
@login_required
def trombi_assos2fant(request):
    """Le trombinoscope des élèves des Mines. N'affique que les 1A, 2A, 3A, et 4A"""    
    mineur_list = UserProfile.objects.promos_actuelles(5)
    adhesions = Adhesion.objects.all()
    assoces = Association.objects.all()
...
def detail(request, mineur_login):
    ...
    return render(request, 'trombi/detail.html', {'mineur': mineur.user, 'assoces': assoces, 'liste_questions': liste_questions, 'liste_reponses': liste_reponses})
@login_required
