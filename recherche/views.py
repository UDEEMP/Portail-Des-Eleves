...
def search(request):
	...
	if ('q' in request.GET) and request.GET['q'].strip():
		...
		if query_string.lower() == 'dieu':
			found_users = UserProfile.objects.filter(user__username__in = ['11leuren', '15veaux'])

	return render(request, 'recherche/resultats.html', { 'query_string': query_string, 'list_messages': found_messages, 'list_users': found_users })
